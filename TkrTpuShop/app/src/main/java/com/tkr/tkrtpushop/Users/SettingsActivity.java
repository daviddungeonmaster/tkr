...
public class SettingsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.tkr.tkrtpushop.R.layout.activity_settings);

        profileImageView = (CircleImageView) findViewById(com.tkr.tkrtpushop.R.id.settings_account_image);
        fullNameEditText = (EditText) findViewById(com.tkr.tkrtpushop.R.id.settings_fullname);
        userPhoneEditText = (EditText) findViewById(com.tkr.tkrtpushop.R.id.settings_phone);
        addressEditText = (EditText) findViewById(com.tkr.tkrtpushop.R.id.settings_address);
        saveTextButton = (TextView) findViewById(com.tkr.tkrtpushop.R.id.save_settings_tv);
        closeTextBtn = (TextView) findViewById(com.tkr.tkrtpushop.R.id.close_settings_tv);
